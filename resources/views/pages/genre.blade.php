...
@section('title',($genre->title) ? $genre->title : 'no such Genre' )
    ...
    <div class="w3_content_agilleinfo_inner">
        <div class="agile_featured_movies">
            <div class="inner-agile-w3l-part-head">
                ...
                <h3 class="w3l-inner-h-title text-left" >{{$genre->title}}</h3>
                <p class="w3ls_head_para">find {{$genre->pictures->count() }}</p>
            </div>
            <div class="latest-news-agile-info">
                <div class="col-md-8 latest-news-agile-left-content">
                    @if($pictures)
                        ...
                        @endforeach
                        @else <h3>No such pictures at {{$gerne->title}} genre</h3>
                    @endif
